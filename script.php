...
//
write($file,"--------------------------------------------------------".PHP_EOL);
write($file,"$kupon_0".PHP_EOL);
write($file,"$kupon_1".PHP_EOL);
write($file,"$kupon_2".PHP_EOL);
write($file,"$kupon_3".PHP_EOL);
write($file,"$kupon_4".PHP_EOL);
write($file,"$kupon_5".PHP_EOL);
write($file,"$kupon_6".PHP_EOL);
write($file,"========================================================".PHP_EOL);
write($file,"Nomor HP : $phone".PHP_EOL);
write($file,"========================================================".PHP_EOL);
write($file,"--------------------------------------------------------".PHP_EOL);  
close($file);  
